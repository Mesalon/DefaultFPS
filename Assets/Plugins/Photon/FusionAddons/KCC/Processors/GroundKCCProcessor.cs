...
namespace Fusion.KCC {
    ...
    public class GroundKCCProcessor : KCCProcessor, IGroundKCCProcessor {
        ...
        public float proportionalKinematicFriction = 35.0f;
        ...
        public override void SetKinematicDirection(KCC kcc, KCCData data) {
            ...
            data.KinematicDirection = KCCUtility.EasyLerpDirection(kinematicDirectionXZ, inputDirectionXZ, data.DeltaTime, inputResponsivity);
            SuppressOtherProcessors(kcc);
        }
        ...
        public override void SetKinematicVelocity(KCC kcc, KCCData data) {
            ...
            if (data.KinematicDirection.IsAlmostZero() == true) {
                data.KinematicVelocity += KCCPhysicsUtility.GetFriction(data.KinematicVelocity, data.KinematicVelocity, Vector3.one, data.GroundNormal, data.KinematicSpeed, true, _constantKinematicFriction, _relativeKinematicFriction, proportionalKinematicFriction, data.DeltaTime, kcc.FixedData.DeltaTime);
            ...
            Vector3 friction = KCCPhysicsUtility.GetFriction(kinematicVelocity, moveDirection, Vector3.one, data.GroundNormal, data.KinematicSpeed, false, _constantKinematicFriction, _relativeKinematicFriction, proportionalKinematicFriction, data.DeltaTime, kcc.FixedData.DeltaTime);
