...
public class DialogueVertexAnimator {
    ...
    public IEnumerator AnimateTextIn(List<DialogueCommand> commands, string processedMessage, float speed, Action onFinish) {
        textAnimating = true;
        float secondsPerCharacter = 1 / speed;
        ...
        Debug.Log($"Info: {textInfo.CopyMeshInfoVertexData()}");
